"""
Utilities for loading collections, stored queries, schemas, and migrations from the spec.
"""
import glob
import os
import yaml
...
def get_collection_schema_for_doc(doc_id):
    """Get the collection schema for a particular document by its full ID."""
